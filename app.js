...
// Tableau contenant les cartes retournés
var openedCards = [];

// Variable quand les cartes sont identiques
let matchedCard = document.getElementsByClassName("match");

// Variable concernant le nombre de move
let moves = 0;
...
// Bouton close des modals
let closeicon = document.querySelector(".close");

// declare modal win/lose
let modalWin = document.getElementById("popupWin");
let modalLose = document.getElementById("popupLose");


/****
 * Quand je charge la page => La partie commence, les cartes se mélangent.
 ****/
 document.body.onload = startGame();


/****
 * Mélange des cartes du deck: retourne un nouveau tableau
 ****/
...
function increase() {
  if (t == 0) {
    ...
    var id = setInterval(frame, 3000); // ms seconde si on veut 5min=300secondes il faut qu'a 100% on soit a 3000 :)
    function frame() {
